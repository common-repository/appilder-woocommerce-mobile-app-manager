...
class Product_Scroller extends  WOOAPP_Widget_Handler{
    ...
    public function getValueById($id){
        if(isset($this->values[$id])){
            return  $this->api_out($this->values[$id]);
        }else{
            if($id=="recent"){
                $products = $this->get_recent_products();
                if(!empty($products)){
                    return $this->api_out(array("title" => __("Recent products"),"products"=>$products));
                }else{
                    return false;
                }
            }elseif($id=="featured"){
                ...
                if(!empty($products)){
                    return $this->api_out(array("title" => __("Featured Products"),"products"=>$products));
                }else{
                    return false;
                }
            }elseif($id=="sale"){
                ...
                if(!empty($products)){
                    return $this->api_out(array("title" => __("Sale Products"),"products"=>$products));
                }else{
                    return false;
                }
                ...
                if(!empty($products)){
                    return $this->api_out(array("title" => __("Best Selling Products"),"products"=>$products));
                }else{
                    return false;
                }
            }elseif($id=="toprated"){
                ...
                if(!empty($products)){
                    return $this->api_out(array("title" => __("Top Rated Products"),"products"=>$products));
                }else{
                    return false;
                }
            }else{
