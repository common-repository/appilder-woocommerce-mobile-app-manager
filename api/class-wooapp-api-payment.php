<?php
/**
 * woocommerce_mobapp API Payment Class
 *
...
class WOOAPP_API_Payment extends WOOAPP_API_Resource {
    ...
    public function checkout_fields($field){
        require_once('class-wooapp-api-payment-checkout-fields.php');
        WOOAPP_API_Checkout_fields::init();
    ...
    private function parse_field($args,$key){
        ...
        return apply_filters("appilder_woocommerce_checkout_field",$args);
    }
    ...
    public function  get_allowed_country_states(){
        ...
        return apply_filters("appilder_woocommerce_allowed_countries",$return);
    }
    public function get_shipping_country_states() {
        ...
        return apply_filters("appilder_woocommerce_shipping_countries",$return);
    }
	public  function get_available_payment_gateways( ) {
        require_once('class-wooapp-api-payment-fields.php');
        WOOAPP_API_Payment_fields::init();
	    ...
	    foreach($available_payment_gateways as $key => $gateway){
            ...
            if(apply_filters('appilder_woocommerce_payment_gateway_'.$gateway->id."_enabled",true)){
                $return['gateways'][]= apply_filters("appilder_woocommerce_payment_gateway_".$gateway->id,array(
                    "id" => $gateway->id,
        ...
        return apply_filters("appilder_woocommerce_payment_gateways_response",$return);
	}
    public function check_out(){
        $return = array();
        require_once('class-wooapp-api-payment-gateway.php');
        WC_Gateway_Appmaker::init();
        ...
        try{
            ...
            ob_get_clean();
            $notice_errors = $this->get_wp_notices_error();
        ...
        $return = apply_filters("appmaker_woocommerce_checkout_response",$return);
        return $return;
    }
