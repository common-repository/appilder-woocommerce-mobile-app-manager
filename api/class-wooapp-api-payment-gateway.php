...
class WC_Gateway_Appmaker extends WC_Payment_Gateway {
    public static function className(){
        return "WC_Gateway_Appmaker";
    }

    public static function init(){
        if(isset($_POST['payment_method']) && in_array($_POST['payment_method'],apply_filters("appmaker_woocommerce_checkout_redirect_gateways",array("stripe")))) {
