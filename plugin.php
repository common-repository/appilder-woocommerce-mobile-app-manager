<?php
/**
 * Plugin Name: Appilder WooCommerce Mobile App Manager ( Depreciated )
 * Plugin URI: https://wordpress.org/plugins/appmaker-woocommerce-mobile-app-manager
 * Description: This plugin have been moved to  <a href="https://wordpress.org/plugins/appmaker-woocommerce-mobile-app-manager/" target="_blank">https://wordpress.org/plugins/appmaker-woocommerce-mobile-app-manager/</a> (Keep this in your wordpress if you have older version of app (App created before oct 2016))
 * Version: 1.8.0
 * Author: Appmaker.xyz
...
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins'))) || is_multisite()) {
    ...
    /*
        ...
        $plugin_updates = new wooapp_wp_auto_update("1.4.1","https://appmaker.xyz/woocommerce/plugin/update","woocommerce-mobile-app-manager/plugin.php");
    */
	...
	function wooapp_api_ts_add_plugin_action_links( $links ) {
		return array_merge(
			array(
				...
				'docs' => '<a target="_blank" href="http://docs.appmaker.xyz/woocommerce/">Docs</a>',
