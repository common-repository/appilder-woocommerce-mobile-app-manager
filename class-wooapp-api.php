...
/**
 * @property WOOAPP_API_Customers $WOOAPP_API_Customers
 * @property WOOAPP_API_Cart $WOOAPP_API_Cart
 * @property WOOAPP_API_AppBase $WOOAPP_API_AppBase
 * @property WOOAPP_API_Orders $WOOAPP_API_Orders
 * @property WOOAPP_API_InAppPages $WOOAPP_API_InAppPages
 * @property WOOAPP_API_Products $WOOAPP_API_Products
 * @property WOOAPP_API_Coupons $WOOAPP_API_Coupons
 * @property WOOAPP_API_Reports $WOOAPP_API_pushNotification
 * @property WOOAPP_API_Widgets $WOOAPP_API_Widgets
 * @property WOOAPP_API_Payment $WOOAPP_API_Payment
 */
