    ...
    class ReduxFramework_slideshow extends widget_handler{
         ...
         */
         ...
         if(!isset($this->value['items']) || empty($this->value['items'])){
             if($this->field_id == "slider_widgets") {
                 $this->value['items'] = array('1' => array('title' => 'Dummy Silder',
                     'slides' => array(
                         array('title' => 'SLIDE 1',
                             'image' => 'http://dummyimage.com/300x100/ecf0f1/000000&text=SLIDE 1',
                             'thumb' => 'http://dummyimage.com/300x100/ecf0f1/000000&text=SLIDE 1'
                         ), array('title' => 'SLIDE 2',
                             'image' => 'http://dummyimage.com/300x100/ecf0f1/000000&text=SLIDE 2',
                             'thumb' => 'http://dummyimage.com/300x100/ecf0f1/000000&text=SLIDE 2'
                         ), array('title' => 'SLIDE 3',
                             'image' => 'http://dummyimage.com/300x100/ecf0f1/000000&text=SLIDE 3',
                             'thumb' => 'http://dummyimage.com/300x100/ecf0f1/000000&text=SLIDE 3'
                         )
                     )));
             }elseif($this->field_id == "grid_widgets") {
                 $this->value['items'] = array('1' => array('title' => 'Dummy Grid',
                     'slides' => array(
                         array('title' => 'Grid Item 1',
                             'image' => 'http://dummyimage.com/200x200/6a97a6/e0e0e0.png&text=GRID+ITEM+1',
                             'thumb' => 'http://dummyimage.com/200x200/6a97a6/e0e0e0.png&text=GRID+ITEM+1'
                         ), array('title' => 'Grid Item 2',
                             'image' => 'http://dummyimage.com/200x200/6a97a6/e0e0e0.png&text=GRID+ITEM+2',
                             'thumb' => 'http://dummyimage.com/200x200/6a97a6/e0e0e0.png&text=GRID+ITEM+2'
                         ), array('title' => 'Grid Item 3',
                             'image' => 'http://dummyimage.com/200x200/6a97a6/e0e0e0.png&text=GRID+ITEM+3',
                             'thumb' => 'http://dummyimage.com/200x200/6a97a6/e0e0e0.png&text=GRID+ITEM+3'
                         ), array('title' => 'Grid Item 4',
                             'image' => 'http://dummyimage.com/200x200/6a97a6/e0e0e0.png&text=GRID+ITEM+4',
                             'thumb' => 'http://dummyimage.com/200x200/6a97a6/e0e0e0.png&text=GRID+ITEM+4'
                         ),
                     )));
             }else{
         ...
         foreach($this->value['items'] as $key=>$value){
            if(!$hidden)
            {
             ...
             if (isset($value['slides']) && is_array($value['slides']) && !$hidden) {
                ...
                foreach ($slides as $slide) {
                    ...
                    echo '<option value="open_webview" '.(($slide['click_action']=='open_webview')?'selected="selected"':'').'> Open WebView </option>';
                    echo '</select></li>';
            ...
            if ($x == 0) {
                ...
                echo '<option  value="open_webview"> Open WebView </option>';
                echo '</select></li>';
