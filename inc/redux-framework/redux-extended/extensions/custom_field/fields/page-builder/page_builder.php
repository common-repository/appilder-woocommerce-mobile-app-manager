    ...
    class ReduxFramework_page_builder
    {
        ...
        function __construct($field = array(), $value = '', $parent)
        {
            ...
            if(!isset($this->value['enabled']) || empty($this->value['enabled'])){
                if($this->field['id']  == 'page_layout_home'){
                    $this->value['enabled']=array(
                        'slider_widgets_1_0' => 'Dummy Silder (#slider_widgets_1)',
                        'grid_widgets_1_0' => 'Dummy Grid (#grid_widgets_1)',
                        'product_scroller_widgets_bestselling' => 'Featured products Scroller (#product_scroller_widgets_featured))'
                    );
                }else
                   $this->value['enabled']=array();
            }
