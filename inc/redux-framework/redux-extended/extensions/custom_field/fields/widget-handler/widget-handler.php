    ...
    class widget_handler {
        ...
        */
        ...
        public function inAppPages_selector_field($field,$value){
            ...
            if ( $pages !== false ) {
	            ...
	            $pages = array( "home" => "Home Page" );
                    ...
                    echo "<select class='$class' $multi data-placeholder='Select a page' name='' id='__toReplace'>";
                    echo "<option></option>";
        ...
        public function url_field($field,$value=""){
                ...
                echo '<input class="widget-action-value-url full-text '.$class.'" type="text" id="__toReplace" name="" placeholder="Enter URL" />';
        }
