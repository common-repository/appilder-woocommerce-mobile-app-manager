...
$args = array(
    ...
    'display_version'   => "1.7.4.6.6",  // Version that appears at the top of your panel
...
/*
 Redux::setSection( $opt_name,array(
                'icon'      => 'el-icon-align-right',
                'title'     => __('Social Login', 'mobapp-settings-page'),
                'fields'    => array(
                    array(
                        'id'       => 'social-login-fb-id',
                        'type'     => 'text',
                        'title'    => __('Facebook Client ID', 'mobapp-settings-page'),
                        'subtitle' => __('Enter the Client ID obtained from facebook', 'mobapp-settings-page'),
                        'default'  => '',
                    ),
                    array(
                        'id'       => 'social-login-fb-secret',
                        'type'     => 'text',
                        'title'    => __('Facebook API Secret', 'mobapp-settings-page'),
                        'subtitle' =>  __('Enter the API SECRET obtained from facebook', 'mobapp-settings-page'),
                        'default'  => '',
                    ),
  /*                  array(
                        'id'       => 'social-login-google-id',
                        'type'     => 'text',
                        'title'    => __('Google Client ID', 'mobapp-settings-page'),
                        'subtitle' => __('Enter the Client ID obtained from Google', 'mobapp-settings-page'),
                        'default'  => '',
                    ),
                    array(
                        'id'       => 'social-login-google-secret',
                        'type'     => 'text',
                        'title'    => __('Google API Secret', 'mobapp-settings-page'),
                        'subtitle' =>  __('Enter the API SECRET obtained from Google', 'mobapp-settings-page'),
                        'default'  => '',
                    ), *//*
                )
));
...
Redux::setSection($opt_name,array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'       => 'apns_production',
                        'type'     => 'switch',
                        'title'    => __('APNS Production', 'redux-framework-demo'),
                        'on'       => 'Production',
                        'off'       => 'Development',
                        'default'  => false,
                    ),
                    array(
                        ...
                        'title'   => 'APNS Development Certificate (.pem)',
                        'desc'    => 'APNS Development Certificate',
                    ),array(
                        'id'      => 'apns_production_cert',
                        'type'    => 'media',
                        // 'mode' => 'application/x-pem-file',
                        'library_filter'=>array('pem'),
                        'title'   => 'APNS Production Certificate (.pem)',
                        'desc'    => 'APNS Production Certificate',
                    ),
                ),
            ));
